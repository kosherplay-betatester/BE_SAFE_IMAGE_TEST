...
def process_image(image, image_url):
            ...
            if bbox_proportion < 0.1111:
                st.markdown(
                    ...
                    <div style="display: flex; align-items: center;">
                        <a href="{image_url}" style="color: gray; margin-right: 5px;">{image_url}</a>
                        <div style="width: 10px; height: 10px; background-color: gray; border-radius: 50%;"></div>
                    </div>
                    """,
    ...
    if crops:
        ...
        for i, crop_probs in enumerate(probs):
            ...
            # If both woman and man scores are below 50%, skip
            if woman_score < 0.50 and man_score < 0.50:
                ...
                st.write("Scores for both 'woman' and 'man' are below 50%, skipped.")
                continue
    ...
    if webpage_url:
        ...
        if image_urls:
            ...
            for idx, image_url in enumerate(image_urls):
                ...
                progress_bar.progress((idx + 1) / len(image_urls))
        else:
